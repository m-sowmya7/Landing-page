        ...
        <div className='container px-4 mx-auto relative text-md'>
            <div className='flex items-center justify-between'>
                ...
                <div className='hidden lg:flex justify-center space-x-12 items-center'>
                    ...
                    <a href='#' className='bg-gradient-to-r from-cyan-600 to-cyan-900 py-2 px-3 rounded-md'>
                        Create an account
                    </a>
                </div>
            ...
            {mobileDrawerOpen && (
                ...
                flex flex-col justify-center items-center lg:hidden'>
                    ...
                    <div className='flex space-x-6'>
                        ...
                        <a href='#' className='py-2 px-3 border rounded-md bg-gradient-to-r from-cyan-600 to-cyan-900 '>
                            Create an account
                        </a>
                    </div>
                </div>
